...
public interface CustomerRepository extends JpaRepository<Customer,Integer>
{
    ...
    @Query("Select new com.tobeto.a.spring.intro.services.dtos.customer.response.GetListCustomerResponse(cu.firstName,cu.lastName, " +
            " new com.tobeto.a.spring.intro.services.dtos.car.response.GetListCarResponse(c.models,c.brands)," +
            " new com.tobeto.a.spring.intro.services.dtos.rental.response.GetListRentalResponse(r.rentalDate,r.endDate))" +
            "From Customer cu INNER JOIN cu.cars c INNER JOIN cu.rentals r " +
            "Where r.rentalDate Between '2023-01-01' And '2024-01-01'")
